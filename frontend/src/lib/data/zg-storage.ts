...
import {ZgStore as VerifiedStore} from "@0g-brier/zg-storage";
 ...
 *
 * The fetching and the Merkle verification live in `@0g-brier/zg-storage`,
...
export {zgMerkleRoot, SpecRootMismatchError} from "@0g-brier/zg-storage";
